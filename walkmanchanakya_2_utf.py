...
def replaceSymbols(modifiedString, font):
    if modifiedString != "":
        ...
        for inputSymbolIdx in range(0, len(walkmanchanakya), 2):
            idx = modifiedString.find(walkmanchanakya[inputSymbolIdx])

            while idx != -1:
                modifiedString = re.sub(
                    re.escape(walkmanchanakya[inputSymbolIdx]),
                    walkmanchanakya[inputSymbolIdx + 1],
                    modifiedString,
                )
                idx = modifiedString.find(walkmanchanakya[inputSymbolIdx])
...
def convertToUni(modifiedString, font):
    ...
    while continu == 1:
        ...
        processedText = re.sub(
            r"(α|β)(क|ख|ग|घ|ङ|च|छ|ज|झ|ञ|ट|ठ|ड|ढ|ण|त|थ|द|ध|न|प|फ|ब|भ|म|य|र|ल|ळ|व|श|ष|स|ह|क़|ख़|ग़|ज़|ड़|ढ़|फ़|य़|ऱ|ऩ)",
            r"\2\1",
            processedText,
        )
        processedText = re.sub(
        ...
        processedText = re.sub(
            r"(क|ख|ग|घ|ङ|च|छ|ज|झ|ञ|ट|ठ|ड|ढ|ण|त|थ|द|ध|न|प|फ|ब|भ|म|य|र|ल|ळ|व|श|ष|स|ह|क़|ख़|ग़|ज़|ड़|ढ़|फ़|य़|ऱ|ऩ)(γ)",
            r"\2\1",
            processedText,
        )
        processedText = re.sub(
